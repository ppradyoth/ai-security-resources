...
*   [💻 AI-Assisted Exploit Generation & Vulnerability Analysis](#-ai-assisted-exploit-generation--vulnerability-analysis)
...
## 💻 AI-Assisted Exploit Generation & Vulnerability Analysis

The evolution of generative AI capabilities directly impacts offensive cybersecurity operations and code security.

### [1] A Survey of Bugs in AI-Generated Code
*   **Authors**: (Empirical Study Authors)
*   **Year**: 2025
*   **Paper Link**: [https://arxiv.org/abs/2512.05239](https://arxiv.org/abs/2512.05239)
*   **Why it Matters**: A crucial empirical study evaluating both functional and security bugs in code generated by modern LLMs. It challenges the assumption that AI coding assistants are inherently secure.
*   **What to pay attention to**: Review the taxonomy of common security flaws (e.g., IDORs, unvalidated inputs) that state-of-the-art models systematically produce without appropriate context/guardrails.

### [2] PentestGPT: An LLM-empowered Automatic Penetration Testing Tool
*   **Authors**: Gelei Deng, et al.
*   **Year**: 2024
*   **Paper Link**: [https://arxiv.org/abs/2308.06782](https://arxiv.org/abs/2308.06782)
*   **Why it Matters**: Details the design and evaluation of an autonomous penetration testing agent powered by GPT-4. Evaluated and published at USENIX Security 2024.
*   **What to pay attention to**: Focus on how the authors engineered the agent to maintain context over long exploit chains and reason about multi-step web vulnerabilities.
